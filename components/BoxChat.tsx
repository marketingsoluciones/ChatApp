...
const BoxChat: FC<propsBoxChat> = ({ active, chat, setChat }) => {
  ...
  return (
    <>
      <div className={`${active ? "" : "hidden"}  z-100  bg-gray-100 lg:flex col-span-12 lg:col-span-9 bg-base w-full h-full flex flex-col  justify-between border-gray-100 border-r`}>
